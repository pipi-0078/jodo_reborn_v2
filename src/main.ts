...
import { createWorldParrot } from './birds/parrot/world.js';
import { createParrotShadow } from './world/parrotShadow';
...
async function main(): Promise<void> {
  ...
  const parrotShadow = createParrotShadow(scene, parrot.bird, sunDirection);
